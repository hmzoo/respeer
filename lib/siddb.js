...
siddb.newUser=function(sid){
  ...
  var psetUserSid=psetSidUser.then(function(result){return setUserSid(rname,sid)});
  return psetUserSid.then(function(result){return Promise.resolve(rname)});
}
